...
// Import the CV to make it accessible via URL
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="bg-gray-100 p-6 rounded-lg flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  For a detailed overview of my professional background, click below:
                </p>
